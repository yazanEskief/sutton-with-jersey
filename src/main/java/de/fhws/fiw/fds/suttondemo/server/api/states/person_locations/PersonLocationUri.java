...
//    String REL_PATH = Start.CONTEXT_PATH + "/api/" + PATH_ELEMENT;
    String REL_PATH = Start.CONTEXT_PATH + "/"  + PATH_ELEMENT;
//    String REL_PATH_SHOW_ALL = Start.CONTEXT_PATH + "/api/" + PATH_ELEMENT + "?" + SHOW_ALL_PARAMETER + "=true";
    String REL_PATH_SHOW_ALL = Start.CONTEXT_PATH + "/"  + PATH_ELEMENT + "?" + SHOW_ALL_PARAMETER + "=true";
//    String REL_PATH_SHOW_ONLY_LINKED = Start.CONTEXT_PATH + "/api/" + PATH_ELEMENT + "?" + SHOW_ALL_PARAMETER + "=false";
    String REL_PATH_SHOW_ONLY_LINKED = Start.CONTEXT_PATH + "/"  + PATH_ELEMENT + "?" + SHOW_ALL_PARAMETER + "=false";
